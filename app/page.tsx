...
|
| NEXT TIME YOU WANT TO OPEN REGISTRATION:
|
| Change:
|
...
export default function EVreadyRegistrationPage() {
  ...
  const downloadQrCard = async () => {
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * html-to-image does not reliably preserve canvas contents.
       * Convert QR canvas into image before generating PNG.
       */
  ...
  return (
    <div
      className="
        ...
        bg-gradient-to-br from-orange-200 via-orange-300 to-amber-200
      "
    >
      {/* =========================================================
          BANNER
          ...
          <CardContent className="p-4 sm:p-6 md:p-8">
            ...
            {!REGISTRATION_OPEN ? (
              <div className="px-2 py-10 text-center sm:px-6 sm:py-14">
                ...
                <h1 className="mt-6 text-2xl font-bold text-orange-700 sm:text-3xl">
                  Registration Closed
                </h1>
              ...
              When you want to reopen registration, simply change:
              ...
              The complete registration form will automatically become
              active again.
                  ...
                  <div className="rounded-lg border border-orange-200 bg-orange-50 p-3">
                    <div className="flex items-start gap-3">
                      <Checkbox
                        ...
                        className="mt-0.5 border-orange-500 data-[state=checked]:border-orange-600 data-[state=checked]:bg-orange-600"
                      />
